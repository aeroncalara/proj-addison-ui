			...
			<Form key={employee} liquid>
				...
				{/* Basic INFORMATION */}
							...
							<Form.Group>
								...
								<Form.Input name="middle_name" label='Middle ' placeholder='Middle Name' width={2} readOnly={this.state.isEdit?false:true} onChange={this.handleChange} value={this.state.middle_name} />
