			...
			<Form>
				...
				{/* Basic INFORMATION */}
							...
							<Form.Group>
								...
								<Form.Input name="first_name" label='First name' placeholder='First Name' />
								<Form.Input name="middle_name" label='Mid Name ' placeholder='Middle Name' width={2}  />
								<Form.Input name="last_name" label='Last Name' placeholder='Last Name' width={3} />
							</Form.Group>
							...
							<Form.Group>
								{/* {this.state.isEdit?
									...
									<Form.Input name="date_of_birth" type="date" label='Birthdate' placeholder='Birthdate' width={2} />
									
									<Form.Input name="date_of_birth" label='Birthdate' placeholder='Birthdate' width={2}  />	
							} 
				...
				{/* ADDITIONAL INFORMATION */}
							...
							<Form.Group>
								...
								<Form.Input name="mobile_number" label='Contact Number' placeholder='Mobile Number'/>
							
								<Form.Input name="email_address" label='Email' placeholder='Email' />
							</Form.Group>
							...
							<Form.Group>
								<div className="two wide field">
									...
									<Form.Input name="number" label='House No.' placeholder='House No.' />
								</div>
								<div className="six wide field">
									...
									<Form.Input name="street" label='Street' placeholder='Street'/>
								</div>
								</Form.Group>
								...
								<Form.Input name="city" label='City / Town' placeholder='City / Town'/>

								<Form.Input name="province" label='Province' placeholder='Province'/>

								<Form.Input name="country" label='Country' placeholder='Country'/>
...
<Form.Input name="title" label='Position' placeholder='Position' />

<Form.Input name="salary" label='Salary' placeholder='Salary'/>
</Form.Group>

<Form.TextArea name="description" label='Title Description' placeholder='Title Description'/>
