			...
			<Form key={employee} liquid>
				...
				{/* ADDITIONAL INFORMATION */}
						...
						<div class="ui large form">
							<Form.Group>
								<Form.Input name="mobile_number" label='Mobile Number' placeholder='Mobile Number'huge readOnly={this.state.isEdit?false:true}  onChange={this.handleChange} value={this.state.mobile_number}/>
				...
				<div className="Edit">
					{
						...
						<List horizontal>
							...
							{/* <List.Item>
								<Button onClick={this.terminateEmployee} negative>Remove Employee</Button>
							</List.Item> */}
						</List>			
					}
				</div>
