		...
		<Tab.Pane> 
			...
			<Form key={employee} liquid>
				...
				{/* ADDITIONAL INFORMATION */}
							...
							<Form.Group>
									<Form.Input class="two wide field" name="number" label='House No.' placeholder='House No.' readOnly={this.state.isEdit?false:true} onChange={this.handleChange} value={this.state.number}/>
