						...
						<div className="left-box">
							...
							<span className="signinwith">Welcome</span>
								...
								<label className="field a-field a-field_a2">
									...
									<input className="field__input a-field__input" name="password" type={this.state.type} onChange={this.handleChange} value={this.state.password} className="password__input" placeholder="Password"/>
