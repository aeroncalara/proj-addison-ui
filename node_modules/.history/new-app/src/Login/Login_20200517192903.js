               ...
               <div  className='LoginContainer'>
            		{/* <Grid> */}
						...
						{/* <Grid.Column>
							...
							<span class="signinwith">Welcome</span>
								...
								<label class="field a-field a-field_a1">
									<input class="field__input a-field__input"  placeholder="-" required onChange={this.handleChange} value={this.state.username}/>
						...
						<label class="field a-field a-field_a2">
							<input class="field__input a-field__input" placeholder="-" required type={this.state.type} onChange={this.handleChange} value={this.state.password} className="password__input" placeholder="Password"/>
							<span class="a-field__label-wrap">
