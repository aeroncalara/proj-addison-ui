            		...
            		{/* <Grid> */}
						...
						{/* <Grid.Column>
							...
							<span class="signinwith">Welcome</span>
								...
								<div className='showpassword' class='ui blue label'>
                                    	<Label className="password__show" onClick={this.showHide} style = {{color: }} >{this.state.type === 'input' ? 'Hide password' : 'Show password'} </Label>
                                </div>
