						...
						{/* <Grid.Column>
							...
							<span className="signinwith">Welcome</span>
								...
								<label className="field a-field a-field_a1">
									...
									{/* <input className="field__input a-field__input" name="username" fluid icon="user" iconPosition="left" placeholder="Username" onChange={this.handleChange} value={this.state.username}/> */}
								...
								<label className="field a-field a-field_a2">
									...
									{/* <input className="field__input a-field__input" name="password" icon="lock" iconPosition="left" type={this.state.type} onChange={this.handleChange} value={this.state.password} placeholder="Password"/> */}

									<input className="field__input a-field__input" name="password" type={this.state.type} onChange={this.handleChange} value={this.state.password} placeholder="Password"/>
