		...
		return (
			<div>
				<Menu inverted style={{height:50}}>
					...
					<Menu.Item position='right' onClick={this.show('mini',false),this.closeConfigShow(true)}>
						<Icon name='setting' />

						<Modal size={size} open={open,this.closeConfigShow(false)} onClose={this.close}>
