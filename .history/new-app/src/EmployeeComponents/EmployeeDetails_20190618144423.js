...
const panes = [
	...
	<Segment raised>
		...
		<Form.Group>
				<Form.Input label='Birthdate' name='birthdate' placeholder='Birthdate' width={2}  readOnly={this.state.isEdit?false:true} onChange={(e) => this.handleChange(e, 'birthDate')} value={employee.person.date_of_birth.toisios}/>
		</Form.Group>
