...
class PayslipReport extends Component {
    ...
    generatePDF = () =>{
        ...
        pdf.setFontSize("13");
        pdf.setFontStyle("bold");
        pdf.text(60 ,194, "Total Benefits");
        ...
        pdf.setFontSize("13");
        pdf.setFontStyle("bold");
        pdf.text(15,206, "INCOME TAX");
        pdf.line(15, 208, 185, 208, "closed");

        pdf.setFontSize(11);
        pdf.text(15, 218, "Income tax ");
        ...
        pdf.setFontSize(11);
        pdf.text(15, 238, "Final Total Earnings ");
        pdf.line(15, 238, 185, 238, "closed");
        ...
        pdf.line(190, 265, 65, 265);
        pdf.text(140, 270, "      RECIEVED BY:")
