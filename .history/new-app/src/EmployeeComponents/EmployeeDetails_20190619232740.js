...
const panes = [
	...
	<Segment raised>
		...
		<Form.Group>
		<Form.Input label='Birthdate' placeholder='Birthdate' width={2}  readOnly={this.state.isEdit?false:true} onChange={(e) => this.handleChange(e, 'birthDate')} value={employee.data.person.date_of_birth}/>
		</Form.Group>
