...
import CalendarTypeTimelogs from '../TimeInOutComponents/CalendarTypeTimelogs';
import PayslipReport from '../EmployeeComponents/PayslipReport';

import ResetPassword from '../ChangePassword/ResetPassword'
import './EmployeeDetails.css';

import {Button ,Header, Image,Tab, List, Form, Icon, Label, Popup , Modal ,Segment,Grid,Message} from 'semantic-ui-react'

import axios from 'axios';      
import {addison_api_url} from '../Utilities/config';
import Calendar from 'react-calendar/dist/umd/Calendar';
import Payslip_Page from './Payslip_Page';
...
const panes = [
	...
	{menuItem: 'Personal', render: () =>
		<Tab.Pane> 
			...
			<Form key={employee} liquid  className='personal_information'>
				<Grid>
					<Grid.Column>
						<Segment >
	...
	{menuItem: 'Position', render: () => 
		<Tab.Pane>
			<Segment fluid className="Position">
...
{/* 
				...
				<div>
					<CalendarTypeTimelogs sessions={sessions.sessions} />
				</div> 
		...
		<div>
			...
			<div className = "EmpTop">
				...
				<div className='EmployeeContent'>
					...
					<Tab style={{width:1130}}menu={{ secondary: true, pointing: true , fluid: true}} panes={panes}/>
