...
const panes = [
	...
	<Segment raised>
		...
		<Form.Group>
				<Form.Input label='Birthdate' placeholder='Birthdate' width={2}  readOnly={this.state.isEdit?false:true} onChange={(e) => this.handleChange(e, 'birthDate')} value={new Date(employee.person.date_of_birth)/>
		</Form.Group>
