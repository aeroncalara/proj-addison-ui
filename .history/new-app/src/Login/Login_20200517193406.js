               ...
               <div  className='LoginContainer'>
            		{/* <Grid> */}
						...
						<label class="field a-field a-field_a2">
							...
							<Form.Input name="password" icon="lock" iconPosition="left" type={this.state.type} onChange={this.handleChange} value={this.state.password} className="field__input" placeholder="Password"/>
